...
public class FixupTools {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (action.equals("update-counts")) {
            ...
            boolean refetch = (args.length > 4) && (args[5].equals("true"));
            ...
            for (Category c : catMatches.keySet())
                System.out.println("Matched category " + c + " with score: " + catMatches.get(c).value());
            pw.close();
            r.close();
            ...
            for (int j = 0; j < loopCount; j++) {
                ...
                for (Issue i : issues) {
                    ...
                    for (Category c : catMatches.keySet())
                        System.out.println("Matched category " + c.getName() + " with score: " + catMatches.get(c).value());
                }
                r.close();
