...
// ############### NON-STATIC FIELDS AND METHODS ############
    ...
    public void addProfileCollection(NR_Collection c) {
        if (_log.isDebugEnabled())
            _log.debug("Add of collection " + c.getName() + " of type " + c.getType().toString());
 ...
 **/
    ...
    private void commitCatToDB(Category cat, boolean purgeAllStaleCacheEntries) {
        if (_log.isDebugEnabled())
            _log.debug("Setting article count for cat " + cat.getName() + ":" + cat.getKey() + ": to " + cat.getNumArticles());
 ...
 **/
    ...
    public void updateArtCounts(Issue i) {
        ...
        if (orig != n) {
            ...
            if (_log.isDebugEnabled())
                _log.debug("Setting article count for issue " + i.getName() + ":" + i.getKey() + ": to " + n);
