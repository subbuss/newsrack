...
insert into cat_news(c_key, n_key, ni_key) (select mapping.c_key, cn.n_key, n.primary_ni_key from cat_news_table cn, v1_to_v2_catmap mapping, news_items n where cn.c_key=mapping.oldkey and cn.nKey = n.n_key);
