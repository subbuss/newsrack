...
$prefix      = "bs";
$defSiteRoot = "http://www.business-standard.com";
$url         = "$defSiteRoot/bsheadline/sectionhome.php";
...
## newspapers.
##
      ## The next line uses information about Business Standard's URL structure
   if ($url =~ m{\&autono=(\d+)}) {
