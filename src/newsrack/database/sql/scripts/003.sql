...
-- Add num_new_articles column to topics and categories
alter table topics add column num_new_articles int default 0;
alter table categories add column num_new_articles int default 0;
