...
<link rel="alternate" type="application/rss+xml" title="NewsRack: '${cat.name}' news in '${issueName}' topic for user ${ownerID}" href="${cat.getRSSFeedURL()}" />
<title>NewsRack: '${cat.name}' news in '${issueName}' topic for user ${ownerID}</title>
