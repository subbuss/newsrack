...
public class SQL_NewsItem extends NewsItem {
    ...
    private static String getGlobalNewsArchive() {
        return SQL_DB._sqldb.getGlobalNewsArchive();
    }
    ...
    public void setDate(Date d) {
        _date = getDateString(d);
    }

    public void setNewsIndexKey(Long idxKey) {
        _newsIndexKey = idxKey;
    }
    ...
    public List<Category> getLeafCategories() {
        return SQL_DB._sqldb.getClassifiedCatsForNewsItem(this, true);
    }

    public List<Category> getAllCategories() {
        return SQL_DB._sqldb.getClassifiedCatsForNewsItem(this, false);
    }

    public int getNumCats() {
        return getLeafCategories().size();
    }
    ...
    public String getLinkForCachedItem() {
        return _localCopyName + ":" + _nKey;
    }
    ...
    public void setNewsIndex(SQL_NewsIndex idx) {
        _newsIndex = idx;
    }
    ...
    public File getRelativeFilePath() {
        return new File(SQL_DB._sqldb.getArchiveDir(getFeed(), getDate()) + getLocalFileName());
    }
