...
public final class NewsRack {
     ...
     */
    public static String getGlobalNewsArchive() {
        return _globalNewsArchive;
    }
    ...
    public static DB_Interface getDBInterface() {
        return _db;
    }
     ...
     */
    public static String getBaseRssDir() {
        return _webappPath + File.separator + getDirPathProperty("rssDir");
    }

    public static boolean testing() {
        return isTrue("testing");
    }

    public static boolean inDebugMode() {
        return isTrue("debugging");
    }
}
