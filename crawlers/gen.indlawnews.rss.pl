...
$newspaper   = "Ind Law News";
$prefix      = "iln";
$defSiteRoot = "http://www.indlawnews.com";
$url         = "$defSiteRoot/";
...
## newspapers.
##
      # The next line uses information about IndLawNews's site organization
   if ($url =~ m{$defSiteRoot/[A-F0-9]+$}) {
